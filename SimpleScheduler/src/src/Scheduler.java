...
public abstract class Scheduler {
	...
	/**
	 * @return true if there are any Jobs in the scheduler (could be running, ready,
	 *         or waiting on IO [in later version of project])
	 */
	 ...
	 * to run. This won't actually start any Job just yet, rather this will block
	 * the thread running this code (the OS simulator) until there is something on
	 * the ready queue.
	 * 
	 ...
	 * trying to acquire a new Job from a potentially empty queue. The "producer"
	 * will be the Submittor thread.
	 * 
	 */
