...
class Submittor extends Thread {
	 ...
	 *                        the type of scheduler we are implementing. For every
	 *                        type of scheduler the first token will be the name of
	 *                        a job/process and the second token will be an integer
	 *                        representing the number of msecs before this job
	 *                        should be submitted to the OS. For a FCFS scheduler
	 *                        the remainder of the string will consist of a single
	 *                        token, an integer equal to the length of the simulated
	 *                        CPU burst in msec.
	 * @param s               = The kernel simulator
	 * @param progenitor      = a factory for creating JobWorkable objects that will
