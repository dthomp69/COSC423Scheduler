...
public class RunScheduler {
	...
	public static void main(String[] args) {
		...
		kernel.start(); // Thread executing this instruction has higher priority, so will continue to
						// hold cpu
		sub.setPriority(7);
		sub.start();
	...
	/**
	 * Copies content of the input file into an array. Each line of input becomes
